...
import {PortL3DC1} from './PortL3DC1';
import {PortL3DC2} from './PortL3DC2';
import {PortL3DC3} from './PortL3DC3';
import {PortL3DC4} from './PortL3DC4';
...
export function PortL3DIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
