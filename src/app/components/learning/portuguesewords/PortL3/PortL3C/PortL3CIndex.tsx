...
import {PortL3CC1} from './PortL3CC1';
import {PortL3CC2} from './PortL3CC2';
import {PortL3CC3} from './PortL3CC3';
import {PortL3CC4} from './PortL3CC4';
...
export function PortL3CIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
            ...
            {isLessonActive ? (
                <div className="ml-10 shadow-xl w-full rounded">
                    <div className="flex items-center rounded">
                        ...
                        <h1 className="text-3xl mt-2">Lesson 3C:</h1>
