...
import {PortL3AC1} from './PortL3AC1';
import {PortL3AC2} from './PortL3AC2';
import {PortL3AC3} from './PortL3AC3';
import {PortL3AC4} from './PortL3AC4';
...
export function PortL3AIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
