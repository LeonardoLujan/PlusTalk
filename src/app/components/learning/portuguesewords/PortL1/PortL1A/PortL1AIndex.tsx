...
import {PortL1AC1} from './PortL1AC1';
import {PortL1AC2} from './PortL1AC2';
import {PortL1AC3} from './PortL1AC3';
import {PortL1AC4} from './PortL1AC4';
...
export function PortL1AIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
