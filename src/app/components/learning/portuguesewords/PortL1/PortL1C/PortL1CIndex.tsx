...
import {PortL1CC1} from './PortL1CC1';
import {PortL1CC2} from './PortL1CC2';
import {PortL1CC3} from './PortL1CC3';
import {PortL1CC4} from './PortL1CC4';
...
export function PortL1CIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
