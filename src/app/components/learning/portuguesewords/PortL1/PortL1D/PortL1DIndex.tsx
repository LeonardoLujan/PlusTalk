...
import {PortL1DC1} from './PortL1DC1';
import {PortL1DC2} from './PortL1DC2';
import {PortL1DC3} from './PortL1DC3';
import {PortL1DC4} from './PortL1DC4';
...
export function PortL1DIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
