...
import {PortL2DC1} from './PortL2DC1';
import {PortL2DC2} from './PortL2DC2';
import {PortL2DC3} from './PortL2DC3';
import {PortL2DC4} from './PortL2DC4';
...
export function PortL2DIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
