...
import {PortL2CC1} from './PortL2CC1';
import {PortL2CC2} from './PortL2CC2';
import {PortL2CC3} from './PortL2CC3';
import {PortL2CC4} from './PortL2CC4';
...
export function PortL2CIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
