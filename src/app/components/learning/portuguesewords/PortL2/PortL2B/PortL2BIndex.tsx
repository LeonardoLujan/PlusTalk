...
import {PortL2BC1} from './PortL2BC1';
import {PortL2BC2} from './PortL2BC2';
import {PortL2BC3} from './PortL2BC3';
import {PortL2BC4} from './PortL2BC4';
...
export function PortL2BIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
