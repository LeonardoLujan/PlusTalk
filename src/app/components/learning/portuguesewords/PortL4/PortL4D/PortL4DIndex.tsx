...
import {PortL4DC1} from './PortL4DC1';
import {PortL4DC2} from './PortL4DC2';
import {PortL4DC3} from './PortL4DC3';
import {PortL4DC4} from './PortL4DC4';
...
export function PortL4DIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
