...
import {SpanL3BC1} from './SpanL3BC1';
import {SpanL3BC2} from './SpanL3BC2';
import {SpanL3BC3} from './SpanL3BC3';
import {SpanL3BC4} from './SpanL3BC4';
...
export function SpanL3BIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
