...
import {SpanL3CC1} from './SpanL3CC1';
import {SpanL3CC2} from './SpanL3CC2';
import {SpanL3CC3} from './SpanL3CC3';
import {SpanL3CC4} from './SpanL3CC4';
...
export function SpanL3CIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
