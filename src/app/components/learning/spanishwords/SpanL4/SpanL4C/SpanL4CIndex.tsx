...
import {SpanL4CC1} from './SpanL4CC1';
import {SpanL4CC2} from './SpanL4CC2';
import {SpanL4CC3} from './SpanL4CC3';
import {SpanL4CC4} from './SpanL4CC4';
...
export function SpanL4CIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
