...
import {SpanL4C1} from './SpanL4C1';
import {SpanL4C2} from './SpanL4C2';
import {SpanL4C3} from './SpanL4C3';
import {SpanL4C4} from './SpanL4C4';

export function SpanL4Index({isLessonActive, onShowLesson, unShowLesson}){
