...
import {SpanL4BC1} from './SpanL4BC1';
import {SpanL4BC2} from './SpanL4BC2';
import {SpanL4BC3} from './SpanL4BC3';
import {SpanL4BC4} from './SpanL4BC4';
...
export function SpanL4BIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
