...
import {SpanL2AC1} from './SpanL2AC1';
import {SpanL2AC2} from './SpanL2AC2';
import {SpanL2AC3} from './SpanL2AC3';
import {SpanL2AC4} from './SpanL2AC4';
...
export function SpanL2AIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
