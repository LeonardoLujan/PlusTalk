...
import {SpanL2DC1} from './SpanL2DC1';
import {SpanL2DC2} from './SpanL2DC2';
import {SpanL2DC3} from './SpanL2DC3';
import {SpanL2DC4} from './SpanL2DC4';
...
export function SpanL2DIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
