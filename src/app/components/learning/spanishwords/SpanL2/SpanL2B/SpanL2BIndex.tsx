...
import {SpanL2BC1} from './SpanL2BC1';
import {SpanL2BC2} from './SpanL2BC2';
import {SpanL2BC3} from './SpanL2BC3';
import {SpanL2BC4} from './SpanL2BC4';
...
export function SpanL2BIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
