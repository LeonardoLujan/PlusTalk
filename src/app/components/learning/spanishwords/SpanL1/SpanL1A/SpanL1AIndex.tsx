...
import {SpanL1AC1} from './SpanL1AC1';
import {SpanL1AC2} from './SpanL1AC2';
import {SpanL1AC3} from './SpanL1AC3';
import {SpanL1AC4} from './SpanL1AC4';
...
export function SpanL1AIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
