...
import {SpanL1DC1} from './SpanL1DC1';
import {SpanL1DC2} from './SpanL1DC2';
import {SpanL1DC3} from './SpanL1DC3';
import {SpanL1DC4} from './SpanL1DC4';
...
export function SpanL1DIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
