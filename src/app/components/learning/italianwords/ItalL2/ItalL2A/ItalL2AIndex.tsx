...
import {ItalL2AC1} from './ItalL2AC1';
import {ItalL2AC2} from './ItalL2AC2';
import {ItalL2AC3} from './ItalL2AC3';
import {ItalL2AC4} from './ItalL2AC4';
...
export function ItalL2AIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
