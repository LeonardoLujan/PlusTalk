...
import {ItalL4CC1} from './ItalL4CC1';
import {ItalL4CC2} from './ItalL4CC2';
import {ItalL4CC3} from './ItalL4CC3';
import {ItalL4CC4} from './ItalL4CC4';
...
export function ItalL4CIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
