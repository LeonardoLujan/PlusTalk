...
import {ItalL4DC1} from './ItalL4DC1';
import {ItalL4DC2} from './ItalL4DC2';
import {ItalL4DC3} from './ItalL4DC3';
import {ItalL4DC4} from './ItalL4DC4';
...
export function ItalL4DIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
