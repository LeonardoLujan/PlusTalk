...
import {ItalL1BC1} from './ItalL1BC1';
import {ItalL1BC2} from './ItalL1BC2';
import {ItalL1BC3} from './ItalL1BC3';
import {ItalL1BC4} from './ItalL1BC4';
...
export function ItalL1BIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
