...
import {ItalL1CC1} from './ItalL1CC1';
import {ItalL1CC2} from './ItalL1CC2';
import {ItalL1CC3} from './ItalL1CC3';
import {ItalL1CC4} from './ItalL1CC4';
...
export function ItalL1CIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
