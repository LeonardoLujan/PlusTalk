...
import {ItalL3CC1} from './ItalL3CC1';
import {ItalL3CC2} from './ItalL3CC2';
import {ItalL3CC3} from './ItalL3CC3';
import {ItalL3CC4} from './ItalL3CC4';
...
export function ItalL3CIndex({isLessonActive, onShowLesson, unShowLesson}: Lesson){
