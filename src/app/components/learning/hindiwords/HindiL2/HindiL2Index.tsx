...
import {HindiL2C1} from './HindiL2C1';
import {HindiL2C2} from './HindiL2C2';
import {HindiL2C3} from './HindiL2C3';
import {HindiL2C4} from './HindiL2C4';
...
export function HindiL2Index({isLessonActive, onShowLesson, unShowLesson}: Lesson){
            ...
            {isLessonActive ? (
                <div className="ml-10 shadow-xl w-full">
                    <div className="flex items-center rounded">
                        ...
                        <h1 className="text-3xl mt-2">Lesson 2: Asking & Answering Questions</h1>
